package hcmute.projectBackend2024.repository;
...
public class ProjectionRepository {
    ...
    //Lấy thông tin tồn kho dựa theo productId liên quan đến bán, tồn kho chưa xử lý, và tổng tồn kho.
    public List<SimpleProductInventoryRequest> findSimpleProductInventories(List<Long> productIds) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<SimpleProductInventoryRequest> query = cb.createQuery(SimpleProductInventoryRequest.class);
        ...
        query.select(cb.construct(
                SimpleProductInventoryRequest.class,
